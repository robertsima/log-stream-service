...
//import com.logstream.generated.model.AlertTriggerAnalysisRequest;
...
//        AlertAnalysisService analysisService = mock(AlertAnalysisService.class);
//        AppService appService = mock(AppService.class);
//        when(analysisService.previewPrompt(any(AlertTrigger.class)))
...
//        verify(analysisService).previewPrompt(any(AlertTrigger.class));
//    }
//
//    @Test
//    void analyzeAlertTrigger_shouldRejectWhenCallerDoesNotOwnApp() {
//        AlertAnalysisService analysisService = mock(AlertAnalysisService.class);
//        AppService appService = mock(AppService.class);
//        AlertTriggerAnalysisRequest request = request();
//        doThrow(new ForbiddenException("You can only manage apps you own."))
//                .when(appService).requireOwner(request.getAppId());
//        AlertAnalysisController controller = new AlertAnalysisController(analysisService, appService, false);
//
//        assertThrows(ForbiddenException.class, () -> controller.analyzeAlertTrigger(request));
//
//        verifyNoInteractions(analysisService);
//    }
//
...
//    }
//
//    private AlertTriggerAnalysisRequest request() {
...
//
//        return new AlertTriggerAnalysisRequest()
